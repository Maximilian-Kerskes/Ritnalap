...
public class Lcd {
	...
	*/
	Lcd(Context pi4j) 
	{
		...
		try 
		{
			...
			writeBlockData(LCD_COMMAND, (byte)(LCD_DISPLAYCONTROL | LCD_DISPLAYON | LCD_CURSOROFF | LCD_BLINKOFF));
	...
	*/
	public void clearText() 
	{
		...
		{
            System.out.println("Lcd - clearText Fehler: Error while trying to initialise " + ex.getMessage());
        }
	}
